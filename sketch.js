var player,maze,healthbar,bulletgroup,ebulletgroup,health=100;
var foodcount=0;
...
if(foodcount>0&&health<100&&keyDown("h")&&player.player){
  health=health+5;
...
food.food27.destroy();
  ...
  if(enemy1.enemy.x<player.player||enemy1.enemy.x>player.player||enemy1.enemy.y<player.player||enemy1.enemy.y>player.player){
   createenemybullet(); 
  }
